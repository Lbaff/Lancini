        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 py-24 md:py-32 sm:px-6 lg:px-8 flex flex-col items-center text-center">
          ...
          <div className="w-full max-w-3xl">
            <div className="flex flex-col md:flex-row gap-3">
              ...
              <Button size="lg" className="bg-success hover:bg-success/80 text-white font-medium px-6">
                Lancer votre projet
              </Button>
            </div>
          </div>
      ...
      <section className="bg-primary text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link to="/signup" className="bg-white text-primary font-medium px-6 py-3 rounded-md hover:bg-gray-100">
              Créer un compte
            </Link>
            <Link to="/post-project" className="bg-success hover:bg-success/80 text-white font-medium px-6 py-3 rounded-md">
              Publier un projet
            </Link>
          </div>
        </div>
